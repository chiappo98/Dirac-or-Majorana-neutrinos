...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{KamLAND.png}
...
The upper limit on Majorana mass resulted in $\langle m_{\beta\beta}\rangle<(61-165)\SI{}{meV}$, as shown in  Figure~\ref{fig:kamSpec}, while the limit on the lightest neutrino mass is obtained as $(180-480)\SI{}{meV}$ at 90\% CL.
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{KamSpectrum.png}
\caption{Effective Majorana mass as a function of the lightest neutrino mass.}
\label{fig:kamSpec}
\end{figure}
\subsubsection{GERDA}
\subsubsection{CUORE}
