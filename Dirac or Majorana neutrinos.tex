...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{Nspectrum.png}
...
Experiments we are going to quickly discuss use three different target materials: Xenon-136 (EXO and KamLAND-Zen), Germanium-76 (GERDA) and Tellurium-130 (CUORE and Cupid-0).
...
\subsubsection{GERDA}
The GERmanium Detector Array experiment worked with high-purity germanium detectors made out of material enriched in \ce{^{76}Ge} to $\sim87\%$. It is located at the Laboratori Nazionali del Gran Sasso of INFN, Italy,  under \SI{3500}{m} of water equivalent of rock.%The detection efficiency in this way was maximized since the detector and the source coincide.
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{GERDA.png}
...
The analysis of Phase II data yields no indication of $0\nu\beta\beta$-decay and set a lower limit of $T_{1/2}>1.5\cdot10^{26}\SI{}{yr}$ at 90\% CL. Combining all the results from Phase I, II , with a total exposure of \SI{127.2}{Kg\cdot yr} led to $T_{1/2}>1.8\cdot10^{26}\SI{}{yr}$ at 90\% CL \cite{ref:gerda}.
\begin{figure}
\centering
...
\label{fig:Tgerda}
\end{figure}
The $T_{1/2}$ limit can be converted into an upper limit on the effective Majorana mass $m_{\beta\beta}<(79-180)\SI{}{meV}$ at 90\% CL.

A new experiment, called LEGEND-200 has taken over the GERDA infrastracture at LNGS and will start data taking in 2021. %%
After some upgrades it should reach a sensitivity of $10^{28}$ and beyond.
