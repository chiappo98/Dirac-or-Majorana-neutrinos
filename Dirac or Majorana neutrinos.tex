...
The Standard Model can be extended to contain \emph{n'} right-handed neutrinos $N_R$
...
\bibitem{ref:Bronc} \BY{Broncano~A. , Gavela~M.B. \atque Jenkins~E.} \TITLE{The Effective Lagrangian for the Seesaw Model of Neutrino Mass and Leptogenesis} [hep-ph/0210271].
\end{thebibliography}
